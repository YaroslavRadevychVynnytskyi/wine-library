...
public class WineController {
    ...
    @PreAuthorize("hasRole('ROLE_ADMIN')")
    @PatchMapping("/{id}/country-image")
    @Operation(summary = "Update wine country image",
            description = "Updates wine's country image by wine id")
    public WineDetailedResponseDto updateCountryImage(
            @PathVariable Long id,
            @RequestBody @Valid UpdateCountryImageRequestDto requestDto) {
        return wineService.updateCountryImage(id, requestDto);
    }
